...
> Runtime: **864 ms**, faster than **86.10%** of Python3 online submissions for 3Sum.
...
+               two_sum = target - v
```
This is not the only part need modification, but you get the idea. [sample1][3sum-counter-arbi-sum] [sample2](https://www.geeksforgeeks.org/unique-triplets-sum-given-value/)
