...
## Synopsis
**[Localization](#localization-algorithm) with LED bulbs**. Each bulb use **[BFSK to broadcast](#broadcast)** its own postion to a receiver, who will estimate its distance to each bulb with **[optical channel model](#optical-channel-model)**. 
